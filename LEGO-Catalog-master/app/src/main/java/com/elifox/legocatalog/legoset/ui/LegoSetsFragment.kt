...
class LegoSetsFragment : Fragment() {
    ...
    private val legoSetsViewModel: LegoSetsViewModel by viewModel()
    ...
    override fun onCreateView(
        ...
        legoSetsViewModel.connectivityAvailable = ConnectivityUtil.isConnected(context!!)
        legoSetsViewModel.themeId = if (args.themeId == -1) null else args.themeId
    ...
    private fun subscribeUi(adapter: LegoSetAdapter) {
        legoSetsViewModel.legoSets.observe(viewLifecycleOwner) {
